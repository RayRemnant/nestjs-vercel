...
`;
  ...
  if (fs.existsSync(webpackConfigPath)) {
    const existingConfig = fs.readFileSync(webpackConfigPath, 'utf8');
    if (JSON.stringify(existingConfig) === JSON.stringify(webpackConfig)) {
      return logFileAlreadyUpdated('webpack.config.js');
    }
  }
